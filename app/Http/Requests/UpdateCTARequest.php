...
class UpdateCTARequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'main_title_jp' => ['required', 'string', 'max:255', 'min:5'],
            'sup_title_jp' => ['required', 'string', 'max:255', 'min:5'],
            'image' => ['nullable', 'image', 'dimensions:min_width=100,min_height=100', 'mimes:jpeg,png'],
    ...
    public function messages()
    {
        return [
            ...
            'image.dimensions' => 'The image dimensions must be at least :min_width x :min_height pixels.',
