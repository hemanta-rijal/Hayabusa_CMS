                ...
                <div class="row">
                    <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                        <div class="custom-buttons">
                            @include('backend.shared.buttons.add-btn', ['route'=> route("events.create")])
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <div class="action-btns">
                                        @include('backend.shared.buttons.edit-btn', ['route' => route('events.edit', $event->id)])
                                        @include('backend.shared.buttons.delete-btn', ['route' => route('events.destroy', $event->id)])
                                    </div>
                                </td>
                            </tr>
                        @endforeach
