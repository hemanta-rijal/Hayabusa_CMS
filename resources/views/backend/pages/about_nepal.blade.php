...
@section('content')
    <div class="row">
        ...
        <form class="row" method="post" enctype='multipart/form-data'
              action="{{ route('page.about-nepal.save') }}">
            @csrf
            @if(isset($page->id))
                                        ...
                                        @for ($i = 0; $i < count(old('nepal', $page->details ?? ["1"])); $i++)
                                            <tr>
                                                <td>
                                                    ...
                                                    @include('backend.shared.form_field_error', ['name' => 'nepal.'. $i .'.title_en'])
                                                </td>
                                                <td>
                                                    <input type="text" class="form-control"
                                                    ...
                                                    @include('backend.shared.form_field_error', ['name' => 'nepal.'. $i .'.value_en'])
                                                </td>
                                                <td>
                                                    <input type="text" class="form-control"
                                                    ...
                                                    @include('backend.shared.form_field_error', ['name' => 'nepal.'. $i .'.title_jp'])
                                                </td>
                                                <td>
                                                    <input type="text" class="form-control"
                                                    ...
                                                    @include('backend.shared.form_field_error', ['name' => 'nepal.'. $i .'.value_jp'])
                                                </td>
                                                <td>
                                                    @if ($i === 0)
...
@push('custom-js')
    ...
    <script>
        $(document).ready(function () {
            ...
            multipleImageEdit(".gallery-input-preview", {!! $page->images !!}, 1024, 9, '/about-nepal/remove_image');
            @else
