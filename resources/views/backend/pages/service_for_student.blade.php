...
@section('title', 'Service for Students Page')

@section('page-title-breadcrumb')
    @include('backend.layouts.page-title', [
        'title' => 'Service for Students Page Content',
        'breadcrumbs' => [
            'Dashboard' => route('dashboard'),
            'Service for Students Page' => ''
        ]
    ])
@endsection
...
@section('content')
    <div class="row">
        ...
        <form class="row" method="post" enctype='multipart/form-data'
              action="{{ route('page.student-services.save') }}">
            @csrf
            @if(isset($page->id))
                    ...
                    <div class="widget-header">
                        <div class="row">
                            <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                                <h4>Service for Students Page Information</h4>
                            </div>
                        </div>
                    </div>
...
@push('custom-js')
    ...
    <script>
        $(document).ready(function () {
            ...
            @if(isset($page->id))
            singleImageEdit(".image", "{!! $page->images['image'] !!}", 1024);
