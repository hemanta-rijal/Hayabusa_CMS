...
<div>
    <div
        style="background: #2e2e2e; color:#fff;padding: 10px;text-align:center;margin:20px 0px;font-size: 18px;font-weight: bold;letter-spacing: 1px;">
    ...
    <div style="padding: 15px;letter-spacing: 0.2px;">
        ...
        <h4>
            Name:&nbsp;<span
                style="font-weight:bold;font-size: 16px;color: #1329c3;text-transform: uppercase;"> {{$data['name']}}</span><br>
            Subject:&nbsp;<span style="font-weight:bold;"> {{$data['subject']}}</span><br>
