...
@section('content')
    ...
    <div class="container">
        <div class="row" style="justify-content: space-between">
            <div class="col-xs-12 col-md-6">
                <img src={{ $page->page_image_link }} data-aos="fade-up" style="width:100%;height:auto" />
            </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-xs-12 col-md-6" style="justify-content: space-between" data-aos="fade-up">
                <div class="sub-title">{{ $page->{'secondary_sub_title_' . config('app.locale')} }}</div>
                <div class="heading">
                    <div class="main-title ">{{ $page->{'secondary_title_' . config('app.locale')} }}</div>
                </div>
                {!! $page->{'secondary_page_description_' . config('app.locale')} !!}
            </div>
            <div class="col-xs-12 col-md-6" data-aos="fade-up">
                <img src={{ asset('frontend/jpgs/study-japan2.png') }} style="width:100%;height:auto" />
            </div>
        </div>
    </div>
    ...
    <div class="container">
        ...
        <div class="heading">
            <div class="main-title" data-aos="fade-up">@lang('site.japan.colleges')</div>
        </div>
        <div class="d-flex" data-aos="fade-up">
            @foreach ($page->images as $image)
                <div class="grid-5">
                    <div class="image-card">
                        <img src="{{ $image->image_link }}" alt="img" />
                    </div>
                </div>
            @endforeach
        </div>
